                ...
                <div class="col-sm">
                    <div class="card border-info mb-3 py-2" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a type="button" class="btn btn-outline-danger" href="/public/eliminarproducto.php?id=<?=$producto['id']?>">Eliminar</a>
                            <a type="button" class="btn btn-outline-warning" href="/public/editarproducto.php?id=<?=$producto['id']?>">Editar</a>
                        </div>
                    </div>
                </div>
                <?php
